...
class App_KernelProductionContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Presentation\\Web\\Controller\\HealthController' => 'getHealthControllerService',
            'App\\Presentation\\Web\\Controller\\IndexController' => 'getIndexControllerService',
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.response', [#[\Closure(name: 'ux.live_component.live_url_subscriber', class: 'Symfony\\UX\\LiveComponent\\EventListener\\LiveUrlSubscriber')] fn () => ($container->privates['ux.live_component.live_url_subscriber'] ?? self::getUx_LiveComponent_LiveUrlSubscriberService($container)), 'onKernelResponse'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Presentation\\Web\\Controller\\HealthController', 'App\\Presentation\\Web\\Controller\\IndexController']);
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['uri_signer'] = $container->createProxy('UriSignerGhostB456bc5', static fn () => \UriSignerGhostB456bc5::createLazyGhost(static fn ($proxy) => self::getUriSignerService($container, $proxy)));
        }
    ...
    {
        $instance = new \Symfony\UX\LiveComponent\EventListener\LiveComponentSubscriber((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
        ...
        if (isset($container->privates['ux.live_component.event_subscriber'])) {
            return $container->privates['ux.live_component.event_subscriber'];
        }

        return $container->privates['ux.live_component.event_subscriber'] = $instance;
    }
     ...
     */
    protected static function getUx_LiveComponent_LiveUrlSubscriberService($container)
    {
        return $container->privates['ux.live_component.live_url_subscriber'] = new \Symfony\UX\LiveComponent\EventListener\LiveUrlSubscriber((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'Symfony\\UX\\LiveComponent\\Metadata\\LiveComponentMetadataFactory' => ['privates', 'ux.live_component.metadata_factory', 'getUx_LiveComponent_MetadataFactoryService', true],
            'Symfony\\UX\\LiveComponent\\LiveComponentHydrator' => ['privates', 'ux.live_component.component_hydrator', 'getUx_LiveComponent_ComponentHydratorService', true],
        ...
        ]))->withContext('ux.live_component.live_url_subscriber', $container));
    }
    ...
    private $loadedDynamicParameters = [
        ...
        'firebase.database_url' => false,
        'firebase.storage_bucket' => false,
        'firebase.credentials' => false,
        'gcp.project_id' => false,
        'gcp.location' => false,
        'kernel.secret' => false,
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'firebase.project_id' => $container->getEnv('FIREBASE_PROJECT_ID'),
            'firebase.database_url' => $container->getEnv('FIREBASE_DATABASE_URL'),
            'firebase.storage_bucket' => $container->getEnv('FIREBASE_STORAGE_BUCKET'),
            'firebase.credentials' => $container->getEnv('FIREBASE_CREDENTIALS'),
            'gcp.project_id' => $container->getEnv('GCP_PROJECT_ID'),
            'gcp.location' => $container->getEnv('GCP_LOCATION'),
